...
Jᵀ = 2.2e-5
Jˢ = 4.9e-7
T_bcs = FieldBoundaryConditions(top = FluxBoundaryCondition(1.5*Jᵀ), bottom = FluxBoundaryCondition(Jᵀ))
S_bcs = FieldBoundaryConditions(top = FluxBoundaryCondition(1.5*Jˢ), bottom = FluxBoundaryCondition(Jˢ))
