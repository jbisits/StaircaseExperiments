...
noise = (velocities = VelocityNoise(1e-2), tracers = TracerNoise(1e-3, 1e-3))
...
output_path = joinpath(@__DIR__, "step_background_$(round(interface_ics.R_ρ, digits = 2))")
