...
scatter!(ax[1], S[1], T[1]; markersize, label="Initial deep density", color=σ_grad[3])
scatter!(ax[1], S[end], T[end]; markersize, label="Initial shallow density", color=σ_grad[2])
...
scatter!(ax[2], S[end], T[end]; markersize, label="Initial shallow density", color=σ_grad[2])
scatter!(ax[2], S[1], T[1]; markersize, label="Initial deep density", color=σ_grad[3])
