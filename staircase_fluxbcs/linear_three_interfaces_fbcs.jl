...
Jᵀ = 2.5e-5
T_bcs = FieldBoundaryConditions(top = FluxBoundaryCondition(0.15*Jᵀ), bottom = FluxBoundaryCondition(0.25*Jᵀ))
Jˢ = 3.2e-7
S_bcs = FieldBoundaryConditions(top = FluxBoundaryCondition(0.15*Jˢ), bottom = FluxBoundaryCondition(0.25*Jˢ))
