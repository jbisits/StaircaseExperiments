...
Jᵀ = 2.5e-5
T_bcs = FieldBoundaryConditions(top = FluxBoundaryCondition(0.4*Jᵀ), bottom = FluxBoundaryCondition(0.4*Jᵀ))
Jˢ = 3.2e-7
S_bcs = FieldBoundaryConditions(top = FluxBoundaryCondition(0.4*Jˢ), bottom = FluxBoundaryCondition(0.4*Jˢ))
